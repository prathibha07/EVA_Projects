...
class Actor(nn.Module): # define actor model with conv layers
    ...
    def forward(self, x):
        ...
        x = F.max_pool2d(self.conv2_bn(self.conv2(x)),2)
...
class Critic(nn.Module): # critic model with conv layers
    ...
    def forward(self, x, u):
        ...
        x1 = x.view(-1, 1, 28, 28)
        x1 = F.max_pool2d(self.conv1(x1),2)
        x1 = F.max_pool2d(self.conv2_bn(self.conv2(x1)), 2)
        x1 = x1.view(-1,320)
        ...
        x2 = F.max_pool2d(self.conv2_bn(self.conv2(x2)), 2)
        x2 = x1.view(-1, 320)
    ...
    def Q1(self, x, u):
        xq = x.view(-1, -1, 28, 28)
        xq = F.max_pool2d(self.conv1(xq), 2)
        xq = F.max_pool2d(self.conv2_bn(self.conv2(xq)), 2)
        xq = xq.view(-1, 320)
